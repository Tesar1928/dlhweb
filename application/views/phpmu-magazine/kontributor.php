			...
			<div class="block">
				...
				<div class="block-content">
					<div class="shortcode-content">
							<div class="column12">
								<div  id="writecomment">
								<p><label for="c_name"><b style='color:red'>PENTING!</b></label><i style='color:black'>Untuk berkontribusi dalam memberikan atau menulis artikel/berita, maka Silahkan Melengkapi form dibawah ini dengan data yang sebenarnya. Terima kasih,.. ^_^</i></p><br>
